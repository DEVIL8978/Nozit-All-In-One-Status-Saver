...
public class LikeeActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        binding.layoutHowTo.imHowto1.setImageResource(R.drawable.likee1);
        binding.layoutHowTo.imHowto2.setImageResource(R.drawable.innn);
        binding.layoutHowTo.imHowto3.setImageResource(R.drawable.likee3);
        binding.layoutHowTo.imHowto4.setImageResource(R.drawable.likee4);
        binding.layoutHowTo.tvHowTo1.setText("1. Open Likee");
        binding.layoutHowTo.tvHowTo3.setText("1. Copy Video Link from Likee");
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            progressDialog.dismiss();
            String imagePath =RootDirectoryLikeeShow+"/"+getFilenameFromURL(VideoUrl);
            Utils.setToast(activity,"Download Completed");
            try {
